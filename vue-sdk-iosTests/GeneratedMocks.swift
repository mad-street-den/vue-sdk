...
import Foundation
 ...
 class MockVueSDKServiceable: VueSDKServiceable, Cuckoo.ProtocolMock {
    
     typealias MocksType = VueSDKServiceable
    
     typealias Stubbing = __StubbingProxy_VueSDKServiceable
     typealias Verification = __VerificationProxy_VueSDKServiceable

     let cuckoo_manager = Cuckoo.MockManager.preconfiguredManager ?? Cuckoo.MockManager(hasParent: false)

    
    private var __defaultImplStub: VueSDKServiceable?

     func enableDefaultImplementation(_ stub: VueSDKServiceable) {
        __defaultImplStub = stub
        cuckoo_manager.enableDefaultStubImplementation()
    }
    ...
    """,
     ...
     struct __StubbingProxy_VueSDKServiceable: Cuckoo.StubbingProxy {
        private let cuckoo_manager: Cuckoo.MockManager
        ...
        func track<M1: Cuckoo.Matchable, M2: Cuckoo.OptionalMatchable, M3: Cuckoo.Matchable, M4: Cuckoo.Matchable>(body: M1, correlationId: M2, success: M3, failure: M4) -> Cuckoo.ProtocolStubNoReturnFunction<([String:Any?], String?, ([String:Any?]) -> Void, ([String:Any?]) -> Void)> where M1.MatchedType == [String:Any?], M2.OptionalMatchedType == String, M3.MatchedType == ([String:Any?]) -> Void, M4.MatchedType == ([String:Any?]) -> Void {
            ...
            return .init(stub: cuckoo_manager.createStub(for: MockVueSDKServiceable.self, method:
    """
    track(body: [String:Any?], correlationId: String?, success: @escaping ([String:Any?]) -> Void, failure: @escaping ([String:Any?]) -> Void) async
    """, parameterMatchers: matchers))
        }
    ...
    """, parameterMatchers: matchers))
     ...
     struct __VerificationProxy_VueSDKServiceable: Cuckoo.VerificationProxy {
        private let cuckoo_manager: Cuckoo.MockManager
        private let callMatcher: Cuckoo.CallMatcher
        private let sourceLocation: Cuckoo.SourceLocation
 ...
 class VueSDKServiceableStub: VueSDKServiceable {
 ...
 class MockVueSDKService: VueSDKService, Cuckoo.ClassMock {
    
     typealias MocksType = VueSDKService
    
     typealias Stubbing = __StubbingProxy_VueSDKService
     typealias Verification = __VerificationProxy_VueSDKService

     let cuckoo_manager = Cuckoo.MockManager.preconfiguredManager ?? Cuckoo.MockManager(hasParent: true)

    
    private var __defaultImplStub: VueSDKService?

     func enableDefaultImplementation(_ stub: VueSDKService) {
        __defaultImplStub = stub
        cuckoo_manager.enableDefaultStubImplementation()
    }
    ...
    """,
     ...
     struct __StubbingProxy_VueSDKService: Cuckoo.StubbingProxy {
        private let cuckoo_manager: Cuckoo.MockManager
        ...
        func track<M1: Cuckoo.Matchable, M2: Cuckoo.OptionalMatchable, M3: Cuckoo.Matchable, M4: Cuckoo.Matchable>(body: M1, correlationId: M2, success: M3, failure: M4) -> Cuckoo.ClassStubNoReturnFunction<([String:Any?], String?, ([String:Any?]) -> Void, ([String:Any?]) -> Void)> where M1.MatchedType == [String:Any?], M2.OptionalMatchedType == String, M3.MatchedType == ([String:Any?]) -> Void, M4.MatchedType == ([String:Any?]) -> Void {
            let matchers: [Cuckoo.ParameterMatcher<([String:Any?], String?, ([String:Any?]) -> Void, ([String:Any?]) -> Void)>] = [wrap(matchable: body) { $0.0 }, wrap(matchable: correlationId) { $0.1 }, wrap(matchable: success) { $0.2 }, wrap(matchable: failure) { $0.3 }]
            return .init(stub: cuckoo_manager.createStub(for: MockVueSDKService.self, method:
    """
    track(body: [String:Any?], correlationId: String?, success: @escaping ([String:Any?]) -> Void, failure: @escaping ([String:Any?]) -> Void) async
    """, parameterMatchers: matchers))
        }
    ...
    """, parameterMatchers: matchers))
     ...
     struct __VerificationProxy_VueSDKService: Cuckoo.VerificationProxy {
        private let cuckoo_manager: Cuckoo.MockManager
        private let callMatcher: Cuckoo.CallMatcher
        private let sourceLocation: Cuckoo.SourceLocation
 ...
 class VueSDKServiceStub: VueSDKService {
